...
public class Preferences extends BaseActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ActivityManager.TaskDescription taskDescription = new ActivityManager.TaskDescription("Amaze", ((BitmapDrawable) getResources().getDrawable(R.mipmap.ic_launcher)).getBitmap(), Color.parseColor(MainActivity.currentTab == 1 ? skinTwo : skin));
        ...
        getSupportActionBar().setBackgroundDrawable(new ColorDrawable(Color.parseColor(MainActivity.currentTab == 1 ? skinTwo : skin)));
        ...
        if (sdk == 20 || sdk == 19) {
            ...
            if (colourednavigation) window.setNavigationBarColor((PreferenceUtils.getStatusColor(MainActivity.currentTab == 1 ? skinTwo : skin)));
    ...
    public void onBackPressed() {
        if (select == 1 && changed == 1) restartPC(this);
    ...
    public void donate() {
        ...
        DonationsFragment donationsFragment = DonationsFragment.newInstance(BuildConfig.DEBUG, true, GOOGLE_PUBKEY, GOOGLE_CATALOG, s, false, null, null, null, false, null, null, false, null);
